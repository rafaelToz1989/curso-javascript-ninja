...
*/
carro.addPessoasCarro = function (quantidade){
    var assentosRestantes = carro.assentos - carro.quantidadePessoas;

    var pluralPessoasTemos = carro.quantidadePessoas === 1 ? ' pessoa' : ' pessoas';
    var pluralPessoasRestantes = assentosRestantes === 1 ? ' pessoa' : ' pessoas';
    var pluralCouber = assentosRestantes === 1  ? ' cabe' : ' cabem';

    var totalPessoas = carro.quantidadePessoas + quantidade;

    if(carro.quantidadePessoas < carro.assentos && totalPessoas > carro.assentos){
         return 'Só' + pluralCouber + ' mais ' + assentosRestantes  + pluralPessoasRestantes + '!';
    }
    ...
    return 'Já temos ' + carro.quantidadePessoas + pluralPessoasTemos + ' no carro!';
