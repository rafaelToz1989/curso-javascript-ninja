...
*/
function returnArray(arrayParam){
    return arrayParam;
}
...
*/
console.log(returnArray(randomArray)[1]);
...
*/
var arrayList = [1, 'array item', true, null, {passe: 'verde', atencao: 'amarelo', pare: 'vermelho'}]

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
console.log(mixedTypeValues(arrayList, 0));
console.log(mixedTypeValues(arrayList, 1));
console.log(mixedTypeValues(arrayList, 2));
console.log(mixedTypeValues(arrayList, 3));
console.log(mixedTypeValues(arrayList, 4));
